...
class Influences:
#################################  MURDERER   #################################
    def challenge_MURDERER_3(self,board,player_1,player_2,player_3
    ,list_challenge,attack):
        ...
        if a.vcards[0]==False and a.vcards[1]==False:
            if a.cards[0]=="MURDERER" or a.cards[1]=="MURDERER":
                ...
                if a.cards[0]=="MURDERER":
                    ...
                    print(A+a.name, ""+E+"this is your new card",
                    A+a.cards[0]+E)
                    if list_challenge[0]==b.name:
                        ...
                        if attack==b.name:
                            ...
                            if b.vcards[0]==False and b.vcards[1]==False:
                                ...
                                " card 1 or card 2? :"))
                                if delete==1:
                                    print(b.cards[0], ""+E+"this is the card"
                                    " that",B+b.name,""+E+"just lost")
                                    b.vcards[0]=True
                                else:
                                    print(b.cards[1], ""+E+"this is the card"
                                    " that", B+b.name, ""+E+"just lost")
                                    b.vcards[1]=True
                            else:
                                if b.vcards[0]==True:
                                    print(B+b.name,""+E+"I´m sorry but you"
                                    " lose, your last card was",
                                     B+b.cards[1]+E)
                                    b.vcards[1]=True
                                else:
                                    print(B+b.name,""+E+"I´m sorry but you"
                        ...
                        if attack==c.name:
                            ...
                            if c.vcards[0]==False and c.vcards[1]==False:
                                print(C+c.cards[0],c.cards[1], ""+E+"this is"
                                "(are) you(r) card(s)")
                                delete=int(input(""+E+"Do you want to lose "
                                "card 1 or card 2? :"))
                                if delete==1:
                                    print(c.cards[0], ""+E+"this is the card"
                                    " that",C+c.name,"just lost")
                                    c.vcards[0]=True
                                else:
                                    print(c.cards[1], ""+E+"this is the card"
                                    " that", C+c.name, "just lost")
                                    c.vcards[1]=True
                            else:
                                if c.vcards[0]==True:
                    ...
                    if list_challenge[0]==b.name:
                        ...
                        if attack==b.name:
                            ...
                            if b.vcards[0]==False and b.vcards[1]==False:
                                print(B+b.cards[0],b.cards[1], ""+E+"this is"
                                " (are) you(r) card(s)")
                                delete=int(input(""+E+"Do you want to lose"
                                " card 1 or card 2? :"))
                                if delete==1:
                                    print(B+b.cards[0], ""+E+"this is the card"
                                    " that", B+b.name,""+E+"just lost")
                                    b.vcards[0]=True
                                else:
                                    print(B+b.cards[1], ""+E+"this is the card"
                                    " that", B+b.name, ""+E+"just lost")
                                    b.vcards[1]=True
                            else:
                                if b.vcards[0]==True:
                        ...
                        if attack==c.name:
                            ...
                            if c.vcards[0]==False and c.vcards[1]==False:
                                ...
                                if delete==1:
                                    ...
                                    print(C+c.cards[1], ""+E+"this is the card"
                                    " that", C+c.name, ""+E+"just lost")
                                    c.vcards[1]=True
                            else:
                                if c.vcards[0]==True:
                                    print(C+c.name,""+E+"I´m sorry but you"
                ...
                " you lose a card")
                if a.vcards[0]==False and a.vcards[1]==False:
                    delete=int(input(""+E+"Do you want to lose card 1 or"
                    " card 2? :"))
                    if delete==1:
                        print(A+a.cards[0], ""+E+"this is the card that",
                        A+a.name, ""+E+"just lost")
                        a.vcards[0]=True
                    else:
                        print(A+a.cards[1], ""+E+"this is the card that", 
                        A+a.name, ""+E+"just lost")
                        a.vcards[1]=True
                else:
                    if a.vcards[0]==True:
                        print(A+a.name,""+E+"I´m sorry but you lose, your"
                        " last card was", A+a.cards[1]+E)
                        a.vcards[1]=True
                    else:
                        print(A+a.name,""+E+"I´m sorry but you lose, "
                        "your last card was", A+a.cards[0]+E)
                        a.vcards[0]=True
            ...
            if a.cards[1]=="MURDERER":
                ...
                if list_challenge[0]==b.name:
                    ...
                    if attack==c.name:
                        ...
                        if c.vcards[0]==False and c.vcards[1]==False:
                            print(C+c.cards[0],c.cards[1], ""+E+"this is"
                            "(are) you(r) card(s)")
                            delete=int(input(""+E+"Do you want to lose card "
                            "1 or card 2? :"))
                            if delete==1:
                                print(C+c.cards[0], ""+E+"this is the card "
                                "that", C+c.name,""+E+"just lost")
                                c.vcards[0]=True
                            else:
                                print(C+c.cards[1], ""+E+"this is the card "
                ...
                win_challenge=2
                if a.vcards[0]==False and a.vcards[1]==False:
                    delete=int(input(""+E+"Do you want to lose card 1 or card "
                    "2? :"))
                    if delete==1:
                        print(A+a.cards[0], ""+E+"this is the card that",
                        A+a.name, ""+E+"just lost")
                    ...
                    if a.vcards[0]==True:
                        print(A+a.name,""+E+"I´m sorry but you lose, your"
                        "last card was", A+a.cards[1])
                        a.vcards[1]=True
                    else:
                        print(A+a.name,""+E+"I´m sorry but you lose, your "
                        "last card was", A+a.cards[0])
                        a.vcards[0]=True
                    ...
                    if attack==c.name:
                        ...
                        if c.vcards[0]==False and c.vcards[1]==False:
                            ...
                            if delete==1:
                                ...
                                print(c.cards[1], "this is the card that",
                                c.name, "just lost")
                                c.vcards[1]=True
                        else:
                            if c.vcards[0]==True:
    ...
    ,attack):
        ...
        if a.vcards[0]==False and a.vcards[1]==False:
                    ...
                    if list_challenge[0]==b.name:
                        ...
                        if attack==b.name:
                            ...
                            if b.vcards[0]==False and b.vcards[1]==False:
                                ...
                                if b.vcards[0]==True:
                                    print(B+b.name,""+E+"I´m sorry but you "
                                    "lose, your last card was", B+b.cards[1]+E)
                                    b.vcards[1]=True
                                else:
                                    print(B+b.name,""+E+"I´m sorry but you "
                                    "lose, your last card was", B+b.cards[0]+E)
                                    b.vcards[0]=True
                else:
                    a.cards[1]=board.cards[0]
                    i=6
            ...
            ...              
    def challenge_MURDERER(self,board,player_1,player_2,player_3,player_4
    ,list_challenge,attack):
        ...
        if a.vcards[0]==False and a.vcards[1]==False:
            if a.cards[0]=="MURDERER" or a.cards[1]=="MURDERER":
                    ...
                    if list_challenge[0]==b.name:
                        ...
                        if attack==c.name:
                            ...
                            if c.vcards[0]==False and c.vcards[1]==False:
                                ...
                                "card 1 or card 2? :"))
                                if delete==1:
                                    print(c.cards[0], ""+E+"this is the "
                                    "card that", C+c.name,"just lost")
                                    c.vcards[0]=True
                                else:
                                    print(c.cards[1], ""+E+"this is the card"
                                    " that",C+c.name, "just lost")
                                ...
                                if c.vcards[0]==True:
                                    print(C+c.name,""+E+"I´m sorry but you "
                                    "lose, your last card was", C+c.cards[1]+E)
                                    c.vcards[1]=True
                                else:
                                    print(C+c.name,""+E+"I´m sorry but you "
                                    "lose, your last card was", C+c.cards[0]+E)
                                    c.vcards[0]=True
                    else:
                        print(list_challenge[0], ""+E+"you lose the challenge")
                        ...
                        if attack==d.name:
                            ...
                            if d.vcards[0]==False and d.vcards[1]==False:
                                print(D+d.cards[0],d.cards[1], ""+E+"this is"
                                "(are) you(r) card(s)")
                                delete=int(input(""+E+"Do you want to lose "
                                "card 1 or card 2? :"))
                                if delete==1:
                                ...
                                if d.vcards[0]==True:
                                    ...
                                    "lose, your last card was", D+d.cards[1]+E)
                                    d.vcards[1]=True
                                else:
                                    print(D+d.name,""+E+"I´m sorry but you "
                                    "lose, your last card was", D+d.cards[0]+E)
                                    d.vcards[0]=True
                else:
                    a.cards[1]=board.cards[0]
                    i=6
                    ...
                    if list_challenge[0]==b.name:
                        ...
                        if attack==d.name:
                            ...
                            if d.vcards[0]==False and d.vcards[1]==False:
                                ...
                                "card 1 or card 2? :"))
                                if delete==1:
                                    print(D+d.cards[0], ""+E+"this is the card"
                                    " that", D+d.name,""+E+"just lost")
                                    d.vcards[0]=True
                                else:
                                    print(D+d.cards[1], ""+E+"this is the card"
                                    " that", D+d.name, ""+E+"just lost")
                                    d.vcards[1]=True
                            else:
                                if d.vcards[0]==True:
                ...
                print (A+a.name,""+E+"sorry, but they know that you "
                "lie :( , you lose a card")
                win_challenge=2 
                if a.vcards[0]==False and a.vcards[1]==False:
                    delete=int(input(""+E+"Do you want to lose card 1 "
            ...
            if a.cards[1]=="MURDERER":
                ...
                if list_challenge[0]==b.name:
                    ...
                    print(list_challenge[0], ""+E+"you lose the challenge")
                    print(D+d.name, ""+E+"I´m sorry but you lose a card")
                    print(D+d.cards[0],d.cards[1], ""+E+"this is(are) you(r) "
                    "card(s)")
                    if attack==d.name:
                        print(D+d.name,""+E+"you are out of the game")
                        d.vcards[0]=True
                        ...
                        if d.vcards[0]==False and d.vcards[1]==False:
                            ...
                            if d.vcards[0]==True:
                                ...
                                "your last card was", E+d.cards[1]+E)
                                d.vcards[1]=True
                            else:
                                print(D+d.name,""+E+"I´m sorry but you lose, "
                                "your last card was", E+d.cards[0]+E)
                                d.vcards[0]=True
            else: 
                print (A+a.name,""+E+"sorry, but they know that you lie :( , "
                "you lose a card")
                    ...
                    if attack==c.name:
                        ...
                        if c.vcards[0]==False and c.vcards[1]==False:
                            ...
                            if delete==1:
                                ...
                                print(c.cards[1], "this is the card" 
                                "that", c.name, "just lost")
                                c.vcards[1]=True
                        else:
                            if c.vcards[0]==True:
                                print(C+c.name,""+E+"I´m sorry but you lose, "
            ...
            ...
#################################  COUNTESS   #################################
    def challenge_COUNTESS_3(self,board,player_1,player_2,player_3
    ,list_challenge):
        A,B,C,E,a,b,c = cond2(board,player_1,player_2,player_3)
        if a.vcards[0]==False and a.vcards[1]==False:
                ...
                if a.cards[0]=="COUNTESS":
                    ...
                    if list_challenge[0]==b.name:
                        ...
                        if b.vcards[0]==False and b.vcards[1]==False:
                            ...
                            if b.vcards[0]==True:
                                print(B+b.name,""+E+"I´m sorry but you lose, "
                                "your last card was", B+b.cards[1])
                                b.vcards[1]=True
                            else:
                                print(B+b.name,""+E+"I´m sorry but you lose, "
                                "your last card was", B+b.cards[0])
                                b.vcards[0]=True
                    elif list_challenge[0]==c.name:
                        print(list_challenge[0], ""+E+"you lose the challenge")
                        print(C+c.name, ""+E+"I´m sorry but you lose a card")
    ...
    def challenge_COUNTESS_2(self,board,player_1,player_2,list_challenge):
        ...
        if a.vcards[0]==False and a.vcards[1]==False:
            ...
            ...
    def challenge_COUNTESS(self,board,player_1,player_2,player_3,player_4,
    list_challenge):
        A,B,C,D,E,a,b,c,d = cond(board,player_1,player_2,player_3,player_4)
        if a.vcards[0]==False and a.vcards[1]==False:
            if a.cards[0]=="COUNTESS" or a.cards[1]=="COUNTESS":
...
#################################    DUKE     #################################
        ...
        if a.vcards[0]==False and a.vcards[1]==False:
            if a.cards[0]=="DUKE" or a.cards[1]=="DUKE":
                ...
                if a.cards[0]=="DUKE":
                    ...
                    if list_challenge[0]==b.name:
                        ...
                        if c.vcards[0]==False and c.vcards[1]==False:
                            ...
                            if c.vcards[0]==True:
                                print(C+c.name,""+E+"I´m sorry but you lose, "
                                "your last card was", C+c.cards[1])
                                c.vcards[1]=True
                            else:
                                print(C+c.name,""+E+"I´m sorry but you lose, "
                                "your last card was", C+c.cards[0])
                                c.vcards[0]=True
                else:
                    a.cards[1]=board.cards[0]
                    i=6
                ...
                if a.vcards[0]==False and a.vcards[1]==False:
                    ...
                    "or card 2? :"))
                    if delete==1:
                        print(A+a.cards[0], ""+E+"this is the card "
                        "that", A+a.name, ""+E+"just lost")
                        a.vcards[0]=True
                    else:
                        print(A+a.cards[1], ""+E+"this is the card "
                        "that", A+a.name, ""+E+"just lost")
                        a.vcards[1]=True
                else:
                    if a.vcards[0]==True:
                        print(A+a.name,""+E+"I´m sorry but you lose, "
                        "your last card was", A+a.cards[1]+E)
                        a.vcards[1]=True
                    else:
                        print(A+a.name,""+E+"I´m sorry but you lose, "
                        "your last card was", A+a.cards[0]+E)
    ...
    def challenge_DUKE_2(self,board,player_1,player_2,list_challenge):
        ...
        if a.vcards[0]==False and a.vcards[1]==False:
            ...
            ...
    def challenge_DUKE(self,board,player_1,player_2,player_3,player_4,
    list_challenge):
        A,B,C,D,E,a,b,c,d = cond(board,player_1,player_2,player_3,player_4)
        if a.vcards[0]==False and a.vcards[1]==False:
            if a.cards[0]=="DUKE" or a.cards[1]=="DUKE":
            ...
            if a.cards[1]=="DUKE":
                ...
                if list_challenge[0]==b.name:
                    ...
                    if d.vcards[0]==False and d.vcards[1]==False:
                        ...
                        if d.vcards[0]==True:
                            print(D+d.name,""+E+"I´m sorry but you lose, your "
                            "last card was", D+d.cards[1]+E)
                            d.vcards[1]=True
                        else:
                            print(D+d.name,""+E+"I´m sorry but you lose, your "
                            "last card was", D+d.cards[0]+E)
                            d.vcards[0]=True
            else: 
                print (A+a.name,""+E+"sorry, but they know that you lie :( , "
                "you lose a card")
            ...
            ...
#################################   CAPTAIN   #################################
    def challenge_CAPTAIN_3(self,board,player_1,player_2,player_3,
    list_challenge):
        A,B,C,E,a,b,c = cond2(board,player_1,player_2,player_3)
        if a.vcards[0]==False and a.vcards[1]==False:
            if a.cards[0]=="CAPTAIN" or a.cards[1]=="CAPTAIN":
                ...
                "you lose a card")
                if a.vcards[0]==False and a.vcards[1]==False:
                    delete=int(input("Do you want to lose card 1 or "
                    "card 2? :"))
                    if delete==1:
                        print(A+a.cards[0], ""+E+"this is the card "
                        "that", A+a.name, ""+E+"just lost")
    ...
    def challenge_CAPTAIN_2(self,board,player_1,player_2,list_challenge):
        ...
        if a.vcards[0]==False and a.vcards[1]==False:
            ...
            ...
    def challenge_CAPTAIN(self,board,player_1,player_2,player_3,player_4,
    list_challenge):
        A,B,C,D,E,a,b,c,d = cond(board,player_1,player_2,player_3,player_4)
        if a.vcards[0]==False and a.vcards[1]==False:
            if a.cards[0]=="CAPTAIN" or a.cards[1]=="CAPTAIN":
                ...
                "you lose a card")
                if a.vcards[0]==False and a.vcards[1]==False:
                    delete=int(input("Do you want to lose card "
                    "1 or card 2? :"))
                    if delete==1:
                        print(A+a.cards[0], ""+E+"this is the card "
                        "that", A+a.name, ""+E+"just lost")
            ...
            ...
################################# AMBASSADOR  #################################  
    def challenge_AMBASSADOR_3(self,board,player_1,player_2,player_3,
    list_challenge):
        A,B,C,E,a,b,c = cond2(board,player_1,player_2,player_3)
        if a.vcards[0]==False and a.vcards[1]==False:
                ...
                if a.cards[0]=="AMBASSADOR":
                    ...
                    if list_challenge[0]==b.name:
                        ...
                        if b.vcards[0]==False and b.vcards[1]==False:
                            print(B+b.cards[0],b.cards[1], ""+E+"this is(are) "
                            "you(r) card(s)")
                            delete=int(input("Do you want to lose card 1 "
                            "or card 2?:"))
                            if delete==1:
                                print(B+b.cards[0], ""+E+"this is the card "
                                "that", B+b.name,""+E+"just lost")
                    ...
                    if list_challenge[0]==b.name:
                        ...
                        print(B+b.name, ""+E+"I´m sorry but you lose a card")
                        if b.vcards[0]==False and b.vcards[1]==False:
                            print(B+b.cards[0],d.cards[1], ""+E+"this is(are) "
                            "you(r) card(s)")
                            delete=int(input(""+E+"Do you want to lose card 1 "
                            "or card 2? :"))
                            if delete==1:
    ...
    def challenge_AMBASSADOR_2(self,board,player_1,player_2,list_challenge):
        ...
        if a.vcards[0]==False and a.vcards[1]==False:
            ...
            ...
    def challenge_AMBASSADOR(self,board,player_1,player_2,player_3,player_4,
    list_challenge):
        A,B,C,D,E,a,b,c,d = cond(board,player_1,player_2,player_3,player_4)
        if a.vcards[0]==False and a.vcards[1]==False:
            if a.cards[0]=="AMBASSADOR" or a.cards[1]=="AMBASSADOR":
...
#################################  PLAY GAME  #################################    
    def play(self,board,player_1,player_2,player_3,player_4,log):
        ...
        if n_players==4 or n_players==3 or n_players==2:
            ...
            if log_==1:
                if log == []:
                    ...
                    for i in range(0,len(log),2):
                        ...
                        print("The player: "+str(log[i])+", played: "
                        ""+str(log[i+1]))
            else:
                print("ok, lets play")
            a.cards = ca1
            ...
            if a.vcards[0]==False and a.vcards[1]==False:
                after_challenge=2
            elif ((a.vcards[0]==False and a.vcards[1]==True) or
             (a.vcards[0]==True and a.vcards[1]==False)):
                after_challenge=1
            else:
                after_challenge=0
            ########################################################
            if a.coins>=10:
                while True:
                    try:
                        p_1=int(input(""+E+"I´m sorry but you need to use "
                        "your coins...you have to use the Coup(=5) or the "
                        "Murderer(=2) wich one do you choose?"))
                        if (p_1 == 5) or (p_1 == 2):
                            if p_1==5:
                                log.append("Coup")
                            else:
                ...
                p_1=int(input (""+E+"wich card do you want to play; "
                "1=Duke, 2=Murderer, 3=Captain, 4=Ambassador, "
                "5=Coup, 6=Income, 7=Foreing aid :"))
                if p_1==1:
                    ...
                    if a.coins>=3:
                        ...
                        while True:
                            try:
                                print(""+E+"I´m sorry but you dont have "
                                "enought coins... pls, chose other number")
                                p_1=int(input(""+E+"wich card do you want to "
                                "play; 1=Duke, 2=Murderer, 3=Captain, "
                                "4=Ambassador, 5=Coup, 6=Income, "
                                "7=Foreing aid :"))
                                if p_1 != 2 and p_1 != 5:
                                    break
                                else:
            ...
            if p_1==2 or p_1==3:
                ...
                print (attack, ",", a.name, "decide to attack you")
            else:
                ...
            if n_players==4:
                    ...
                    if p_2==1 and p_3==1 and p_4==1:
                        ...
                        if p_1==1:
                            if a.vcards[0]==False and a.vcards[1]==False:
                                ...
                                before_challenge=1
                            self.challenge_DUKE(board,player_1,player_2,
                            player_3,player_4,list_challenge)
                        elif p_1==2:
                            if a.vcards[0]==False and a.vcards[1]==False:
                                before_challenge=2
                            else:
                                before_challenge=1
                            self.challenge_MURDERER(board,player_1,player_2,
                            player_3,player_4,list_challenge,attack)
                        elif p_1==3:
                            if a.vcards[0]==False and a.vcards[1]==False:
                                before_challenge=2
                            else:
                                before_challenge=1
                            self.challenge_CAPTAIN(board,player_1,player_2,
                            player_3,player_4,list_challenge)
                        else:
                            if a.vcards[0]==False and a.vcards[1]==False:
                                before_challenge=2
                                ...
                                before_challenge=1
                            self.challenge_AMBASSADOR(board,player_1,player_2,
                            player_3,player_4,list_challenge)
                    ...
                    if p_2==1 and p_3==1:
                        ...
                        if p_1==1:
                            if a.vcards[0]==False and a.vcards[1]==False:
                                ...
                                before_challenge=1
                            self.challenge_DUKE_3(board,player_1,player_2,
                            ...
                            if a.vcards[0]==False and a.vcards[1]==False:
                                ...
                                before_challenge=1
                            self.challenge_MURDERER_3(board,player_1,player_2,
                            player_3,list_challenge,attack)
                            if a.vcards[0]==False and a.vcards[1]==False:
                                after_challenge=2
                            ...
                            if a.vcards[0]==False and a.vcards[1]==False:
                                ...
                                before_challenge=1
                            self.challenge_CAPTAIN_3(board,player_1,player_2,
                            player_3,list_challenge)
                        else:
                            if a.vcards[0]==False and a.vcards[1]==False:
                                before_challenge=2
                                ...
                                before_challenge=1
                            self.challenge_AMBASSADOR_3(board,player_1,
                                    ...
                                    if attack==b.name:
                                        ...
                                        if (b.vcards[0]==False and
                                         b.vcards[1]==False):
                                            ...
                                            if b.vcards[0]==True:
                                                ...
                                                "last card was", B+b.cards[1])
                                                b.vcards[1]=True
                                            else:
                                                print(B+b.name,""+E+"I´m "
                                                "sorry but you lose, your "
                                                "last card was", B+b.cards[0])
                                                b.vcards[0]=True
                                    elif attack==c.name:
                                        ...
                                        if (c.vcards[0]==False and
                                         c.vcards[1]==False):
                                            ...
                                            "want to lose card 1 or card 2?:"))
                                            if delete==1:
                                                print(C+c.cards[0],""+E+"this "
                                                "is the card that",
                                                 C+c.name,""+E+"just lost")
                                                c.vcards[0]=True
                                            else:
                                                print(C+c.cards[1],""+E+"this "
                                                "is the card that", C+c.name,
                                                ""+E+"just lost")
                                                c.vcards[1]=True
                                        else:
                                            if c.vcards[0]==True:
                                                ...
                                                "sorry but you lose, your "
                                                "last card was",C+c.cards[1]+E)
                                                c.vcards[1]=True
                                            else:
                                                print(C+c.name,""+E+"I´m sorry"
                                                " but you lose, your last "
                                                "card was", C+c.cards[0]+E)
                                                c.vcards[0]=True   
###############################################################################
                        else:
                            print(""+E+"no challenge")
                    ...
                    if p_1==7:
                            ...
                            if ask==2:
                                if attack==b.name:
                                    ...
                                    if (b.vcards[0]==False and
                                     b.vcards[1]==False):
                                        ...
                                        if delete==1:
                                            ...
                                            "the card that", B+b.name,
                                            ""+E+"just lost")
                                            b.vcards[0]=True
                                        else:
                                            print(B+b.cards[1], ""+E+"this is "
                                            "the card that", B+b.name,
                                            ""+E+"just lost")
                                            b.vcards[1]=True
                                    else:
                                    ...
                                    if (c.vcards[0]==False and
                                     c.vcards[1]==False):
                                        print(C+c.cards[0],
                                        c.cards[1], ""+E+"this is(are) "
                                        "you(r) card(s)")
                                        delete=int(input(""+E+"Do you want to "
                                        "lose card 1 or card 2? :"))
                                        if delete==1:
                                            print(C+c.cards[0], ""+E+"this is "
                                            "the card that", C+c.name,
                                            ""+E+"just lost")
                                            c.vcards[0]=True
                                        else:
                                            print(C+c.cards[1], ""+E+"this "
                                ...
                                if p_2==1 and p_3==1:
                                    ...
                                    B = col2
                                    if after_challenge == before_challenge:
                                        print (""+E+" you can´t have the two "
                                        "coins")
                                    else: 
                                        a.coins+=2 
                                        print( ""+E+" you can have the two "
                                        "coins")
                                elif p_2==1:
                                    if (a.vcards[0]==False and
                                     a.vcards[1]==False):
                        ...
                        print (""+E+"To defense this attack you will need the"
                        " ambassador or the captain")
                        print (attack)                
                        ask_a_c=int(input(""+E+"Do you want to defense? 1= yes"
                        " 2= no :"))
                        if ask_a_c==2:
                            if attack==b.name:
                                if b.coins>=2:
                            ...
                            if ask_a_c==2:
                                ...
                                if p_2==2 and p_3==0:
                                    if ask2==1:
                                        ...
                                        print(""+E+"the attack can´t be done")
                                elif p_2==1 or p_3==1:
                                    #a = b
                                    a.cards = ca2
                                    a.vcards = vc2
...
#######################################################################                    
                ...
                if n_players!=4:
                    if n_players==3:
                        ...
                        p_3=2
                if p_2==2 and p_3==2 and p_4==2:
                    print(A+a.name,""+E+"you can choose 2 cards between "
                    "your own cards and 2 of the desk")
                    if a.vcards[0]==False and a.vcards[1]==False:
                        print(""+E+"this are the cards, you have to choose "
                        "1 each time")
                        print(A+a.cards[0],""+E+"=1",A+a.cards[1],""+E+"=2",
                        board.cards[0],"=3",board.cards[1],"=4")
                        value_1=int (input("enter the frist card that you "
                        "want, JUST the frist one:"))
                        value_2=int (input("now enter the second card "
                        "that you want :"))
                        while value_1==value_2:
                            print("you can´t choose", value_1,"and",
                            value_2,"please make them different")
                            value_1=int (input("enter the frist card that you "
                            "want, JUST the frist one:"))
                            value_2=int (input("now enter the second card "
                            "that you want :"))
                        ...
                        if value_2==4:
                            ...
                            ...
                        print(A+a.name, ""+E+"this are your cards after your "
                        "choice:")
                        print(A+a.cards[0],a.cards[1])
                    else:
                        print(A+a.name,""+E+"you can choose 1 cards between "
                        "your own card and 2 of the desk")
                        print(""+E+"this are the cards, you have to choose 1")
                        if a.vcards[0]==True:
                            print(A+a.cards[1],""+E+"=1",board.cards[0],"=3",
                            board.cards[1],"=4")
                            value_1=int (input("Wich card do you want? "
                            "(1,2,3):"))
                            if value_1==2:
                                help_issue=a.cards[1]
                                a.cards[1]=board.cards[0]
                ...
                if p_2==1:
                    if after_challenge != before_challenge:
                        print (""+E+"I´m sorry", A+a.name, ""+E+"but you "
                        "can´t play the ambassador")
                    else: 
                        print(A+a.name,""+E+"you can choose 2 cards between "
                        "your own cards and 2 of the desk")
                        if a.vcards[0]==False and a.vcards[1]==False:
                            print(""+E+"this are the cards, you have to "
                            "choose 1 each time")
                            print(A+a.cards[0],""+E+"=1",A+a.cards[1],
                            ""+E+"=2",board.cards[0],"=3",board.cards[1],"=4")
                            value_1=int (input("enter the frist card that you "
                            "want, JUST the frist one:"))
                            value_2=int (input("now enter the second card "
                            "that you want :"))
                            while value_1==value_2:
                                print("you can´t choose", value_1,"and",
                                value_2,"please make them different")
                                value_1=int (input("enter the frist card "
                                "that you want, JUST the frist one:"))
                                value_2=int (input("now enter the second "
                                "card that you want :"))
                            if value_1==2:
                                a.cards[0]=a.cards[1]
                            elif value_1==3:
                                ...
                                ...
                            print(A+a.name, ""+E+"this are your cards after "
                            "your choice:")
                            print(A+a.cards[0],a.cards[1])
                        else:
                            print(A+a.name,""+E+"you can choose 1 cards "
                            "between your own card and 2 of the desk")
                            print(""+E+"this are the cards, you have to "
                            "choose 1")
                            if a.vcards[0]==True:
                                print(A+a.cards[1],""+E+"=1",
                                board.cards[0],"=3",board.cards[1],"=4")
                                value_1=int (input("Wich card do you want? "
                                "(1,2,3):"))
                                if value_1==2:
                ...
                if n_players==4:
                    if p_2==2 and p_3==2 and p_4==2:
                        ...
                        if a.vcards[0]==False and a.vcards[1]==False:
                            ...
                            after_challenge=0
                        if after_challenge == before_challenge:
                            print(A+a.name,""+E+"good for you! you earn "
                            "3 coins")
                            a.coins +=3
                        else: 
            ...
            if p_1==2:
                if n_players==2:
                    if n_players==2:
                        print(a.name)
                        p_1=int(input(""+E+"Do you want to do a challenge; "
                        "1 yes 2 no :"))
                        if p_1==2:
                            print("You can use your defense")
                        else:
                            print (b.name,"," ,a.name,"don´t belive you, "
                            "you go to challenge")
                            a.cards = ca2
                            a.vcards = vc2
                            a.name = nombre2
                            ...
                            B = col1
                            list_challenge.append(b.name)
                            self.challenge_COUNTESS_2(board,player_1,
                            player_2,list_challenge)
                            if a.vcards[0]==False and a.vcards[1]==False:
                                after_challenge=2
                            elif a.vcards[0]==False and a.vcards[1]==True: 
                        ...
                        if p_1==2 and p_2==2:
                            ...
                            print (b.name,"," ,c.name,"don´t belive you, "
                            "you go to challenge")
                            a.cards = ca2
                            a.vcards = vc2
                            a.name = nombre2
                            ...
                            B = col1
                            list_challenge.append(c.name)
                            self.challenge_COUNTESS_3(board,player_1,player_2,
                            player_3,list_challenge)
                            if a.vcards[0]==False and a.vcards[1]==False:
                                after_challenge=2
                            elif a.vcards[0]==False and a.vcards[1]==True: 
                            ...
                            list_challenge.append(c.name)
                            random.shuffle(list_challenge)
                            print (b.name,"," ,a.name, "and",c.name,"don´t "
                            "belive you, you go to challenge")
